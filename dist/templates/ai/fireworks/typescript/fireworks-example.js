...
if (!fireworksApiKey) {
    console.error("FIREWORKS_API_KEY not found. Please set it in your .env file or environment variables.");
    process.exit(1);
}
...
async function main() {
    ...
    const textToTranslate = "FireworksAI provides access to many open source models.";
    ...
    const question = "How can I use function calling with FireworksAI models via Langchain?";
