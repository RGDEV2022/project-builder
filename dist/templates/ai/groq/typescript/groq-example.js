...
if (!groqApiKey) {
    console.error("GROQ_API_KEY not found. Please set it in your .env file or environment variables.");
    process.exit(1);
}
const model = new ChatGroq({
    apiKey: groqApiKey,
    model: "llama3-70b-8192", // Updated model name from docs (llama-3.3-70b-versatile is not in current dropdown, llama3-70b-8192 is)
